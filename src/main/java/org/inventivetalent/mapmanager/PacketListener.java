...
class PacketListener {
    ...
    private static final FieldResolver Vec3DFieldResolver = new FieldResolver(MapManagerPlugin.nmsClassResolver.resolveSilent("Vec3D", "world.phys.Vec3D"));
    private static final FieldResolver PacketUseEntityFieldResolver = new FieldResolver(MapManagerPlugin.nmsClassResolver.resolveSilent("PacketPlayInUseEntity", "network.protocol.game.PacketPlayInUseEntity"));
    private static final FieldResolver PacketCreativeSlotFieldResolver = new FieldResolver(MapManagerPlugin.nmsClassResolver.resolveSilent("PacketPlayInSetCreativeSlot", "network.protocol.game.PacketPlayInSetCreativeSlot"));

    private static final MethodResolver CraftItemStackMethodResolver = new MethodResolver(MapManagerPlugin.obcClassResolver.resolveSilent("inventory.CraftItemStack"));
    ...
    protected Vector vec3DtoVector(Object vec3D) {
        ...
        try {
            double a = Vec3DFieldResolver.resolveAccessor("x"/*1.9*/, "a").get(vec3D);
            double b = Vec3DFieldResolver.resolveAccessor("y"/*1.9*/, "b").get(vec3D);
            double c = Vec3DFieldResolver.resolveAccessor("z"/*1.9*/, "c").get(vec3D);
